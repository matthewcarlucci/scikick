...
test_datadir = os.path.join(exe_dir, "data", "test_ignorecase")
...
htmls = ["code/analysis_summary.html", "index.html",
	"code/test_python.html", "code/data_generate.html",
	"code/test_bash.html"]
...
class TestIgnorecase:
	...
	def test_run(self):
		os.system("%s add code/data_generate.Rmd" % cli_name)
		os.system("%s add code/analysis_summary.rmd -d code/data_generate.Rmd" % cli_name)
